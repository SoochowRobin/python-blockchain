...
class Transaction:
	...
	def __init__(
		...
		self.id = id or str(uuid.uuid4())[0:8] # slice the string to have a shorter id 
	...
	def update(self, sender_wallet, recipient, amount):
		"""
		Update the transaction with an exising or new recipient.
		"""
	...
	def from_json(transaction_json):
		"""
		Deserialize a transaction' json representation back 
